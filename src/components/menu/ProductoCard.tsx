    ...
    <View className="mb-4 overflow-hidden rounded-3xl border border-white/60 bg-[#FFF4E6] shadow-sm">
      ...
      <View className="p-4">
        <View className="flex-row items-start justify-between gap-2">
          <Text className="flex-1 text-lg font-black text-[#1E2342]" numberOfLines={2}>
            {producto.nombre}
          </Text>
          <Text className="text-lg font-extrabold text-[#1E2342]">
            ${Number(producto.precio).toLocaleString("es-AR")}
          </Text>
        </View>

        <Text className="mt-2 text-xs leading-5 text-[#7A6C5E]">
